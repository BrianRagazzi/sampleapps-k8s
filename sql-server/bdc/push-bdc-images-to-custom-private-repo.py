...
SOURCE_DOCKER_REGISTRY = "mcr.microsoft.com" #input("Provide Docker registry source - press ENTER for using `mcr.microsoft.com`:") or "mcr.microsoft.com"
SOURCE_DOCKER_REPOSITORY = "mssql/bdc" #input("Provide Docker repository source - press ENTER for using `mssql/bdc`:") or "mssql/bdc"
...
SOURCE_DOCKER_TAG = "latest" #input("Provide Docker tag for the images at the source: ") or "latest"

TARGET_DOCKER_REGISTRY = "harbor.pae.ragazzilab.com" #input("Provide Docker registry target:")
TARGET_DOCKER_REPOSITORY = "bdc" #input("Provide Docker repository target:")
...
TARGET_DOCKER_TAG = "latest" #input("Provide Docker tag for the images at the target: ") or "latest"
